...
fun ImageView.load(
    ...
    return loadAny(bitmap, requestBuilder)
}
...
fun ImageView.load(
    ...
    return loadAny(byteArray, requestBuilder)
}
...
fun ImageView.load(
    ...
    return loadAny(drawable, requestBuilder)
}
...
fun ImageView.load(
    ...
    return loadAny(resourceId, requestBuilder)
}
...
fun ImageView.load(
    ...
    return loadAny(uri, requestBuilder)
}
/** See also {@link #ImageView.loadAny(
 *                       Any?,
 *                       TransitionOptions<*, Drawable>? = null,
...
fun ImageView.load(
    ...
    return loadAny(string, requestBuilder)
}
/** See also {@link #ImageView.loadAny(
 *                       Any?,
 *                       TransitionOptions<*, Drawable>? = null,
...
fun ImageView.load(
    ...
    return loadAny(file, requestBuilder)
}
/**
...
inline fun ImageView.load(
    string: String?,
    transitionOptions: TransitionOptions<*, Drawable>,
    requestOptions: RequestOptions.() -> Unit
): ViewTarget<ImageView, Drawable> {
    return loadAny(string, transitionOptions, requestOptions)
}
